<section class="blog-two">
    <div class="container">
        ...
        <div class="blog-two__carousel owl-carousel owl-theme">
            @foreach($news as $new)
            <div class="item">
                <div class="blog-two__single" style="background-image: url('{{url($new->image ? \App\Services\ImgResize::ImgCopy($new->image,320,320) : 'assets/images/blog-2-3.jpg')}}');">
                    <div class="blog-two__inner">
                        <a href="news-details.html" class="blog-two__date">
                            <span>{{Carbon\Carbon::parse($new->created_at)->format('d')}}</span>
                            {{Carbon\Carbon::parse($new->created_at)->format('M')}}
                        </a><!-- /.blog-two__date -->
                        <div class="blog-two__meta">
                            <a href="{{url('new/'.$new->id)}}">{{$new->author}}</a>
                            <a href="{{url('news/'.$new->newstypes->slug)}}">{{$new->newstypes->name ?? 'рубрика'}}</a>
                        </div><!-- /.blog-two__meta -->
                        <h3 class="blog-two__title">
                            <a href="news-details.html">{{$new->title ?? 'Заголовок новини'}}</a>
                        </h3><!-- /.blog-two__title -->
                    </div><!-- /.blog-two__inner -->
