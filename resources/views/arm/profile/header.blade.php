<div class="topbar-one" style="position: fixed; width:100%; height: 32px; font-zie:12px; line-height: normal">
    <div class="container" style="margin-left: 0">
        <div class="topbar-one__left" style="display: block">

            <div>
                <a href="{{url('/')}}" title="Повернутися на головну сторінку сайту"><i class="fas fa-home"></i></a>
            </div>
